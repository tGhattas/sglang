...
#   docker build --build-arg SGL_BRANCH=v0.5.8 --build-arg GPU_ARCH=gfx942-rocm720 -t v0.5.8-rocm720-mi30x-preview -f rocm720.Dockerfile .
#   docker build --build-arg SGL_BRANCH=v0.5.8 --build-arg GPU_ARCH=gfx950 -t v0.5.8-rocm700-mi35x -f rocm.Dockerfile .
#   docker build --build-arg SGL_BRANCH=v0.5.8 --build-arg GPU_ARCH=gfx950-rocm720 -t v0.5.8-rocm720-mi35x-preview -f rocm720.Dockerfile .
